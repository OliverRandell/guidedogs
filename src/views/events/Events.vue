        ...
        <div class="container">
            <div class="pg-content">
                ...
                <div class="event-listings" ref="eventListing" tabindex="-1">
                    ...
                    <EventListing :categoryId="categoryId" :searchString="searchString" :pageNumber="pageNumber" v-on:reached-last="setLastPage" />
                    <div class="col-12">
                ...
                <aside class="event-filters" role="group">
                    ...
                    <EventListingFilter v-on:filter-events="categoryFilterEvents" v-bind:categoryId="categoryId" />
                </aside>
